...
/**
 * Represents the admin languages create guard.
 * @class
 */
@Injectable()
export class LanguagesCreateGuard extends BaseRigthsGuard {
  /**
   * Initialize the LanguagesCreateGuard class.
   * @constructor
  ...
  constructor(
    ...
    super(authorizationGuardService, storageService, router, 'R_API_LANGUAGE_C');
  }
}
